          ...
          <div className="flex md:flex-row flex-col ">
            <div>
              ...
              <div className="flex md:flex-col gap-3 border-l-2 md:border-none border-[#bd93f9] pl-3 md:ml-0 ml-3 md:pl-0 md:h-fit h-[40px] items-center md:items-start">
                <FaInstagram className="text-[#6272a4] text-3xl cursor-pointer hover:text-[#bd93f9] transition-all duration-300" />
                <FaLinkedin className="text-[#6272a4] text-3xl cursor-pointer hover:text-[#bd93f9] transition-all duration-300" />
                <FaGithub className="text-[#6272a4] text-3xl cursor-pointer hover:text-[#bd93f9] transition-all duration-300" />
              </div>
            </div>
